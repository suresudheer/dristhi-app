...
public class NativeFPSmartRegisterActivityTest extends ActivityInstrumentationTestCase2<NativeFPSmartRegisterActivity> {

    NativeFPSmartRegisterActivity ecActivity;

    public NativeFPSmartRegisterActivityTest() {
        super(NativeFPSmartRegisterActivity.class);
    }
